...
namespace AllAspFunction
{
    public class Function
    {
        public static String Connection = ConfigurationManager.ConnectionStrings["InfoDbContext"].ToString(); // connection string

        public static void DropDownAdd(DropDownList ob, String sql) // drop down list add
        {
        ...
        public static void DropDownAddWithSelect(DropDownList ob, String sql) // drop down list add with 'select' test at first
        {
            List<String> list = new List<string>();
            try
            {
        ...
        public static void DropDownAddWithAll(DropDownList ob, String sql)   // drop down list add with 'all' test at first
        {
            List<String> list = new List<string>();
            try
            {
        ...
        public static void EditableDropDownAdd(DropDownList ob, String sql) // editable drop down list add with 'select' test at first
        {
            List<String> list = new List<string>();
            try
            {
        ...
        public static void ListAdd(ListBox ob, String sql) //  List add with 'select' test at first
        {
            List<String> list = new List<string>();
            try
            {
        ...
        public static void TxtAdd(String sql, TextBox txtadd) // Text box data add 
        {
            //String mystring = "";
            try
            {
        ...
        public static void LblAdd(String sql, Label lblAdd) // lavel box data add 
        {
            try
            {
                SqlConnection con = new SqlConnection(Connection);
        ...
        public static string StringData(String sql)   // Add data in string variable
        {
            string data = "";
            try
            {
        ...
        public static string StringDataOneParameter(String sql, String parameterValue)   // Add data in string variable and paramiter
        {
            string data = "";
            try
            {
        ...
        public static void GridViewAdd(GridView ob, String sql)   // Add data in grid view
        {
        ...
        public static string FbProfilePicture(string userId, string dbUserNameQuery)
        {
            string fbusername = StringData(dbUserNameQuery);
